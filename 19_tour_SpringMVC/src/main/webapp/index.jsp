...
<body>
<div>
	<a href="Lcontroller.do?command=mainPage" style="font-size: 20px;" ><img alt="" src="img/main.jpg" style="height: 100px; width: 150px;" title="메인 페이지"></a>
</div>
<div class="container">
	<form action="Ucontroller.do" method="post" class="form-signin">
		...
		<table>
			...
			<tr>
				<td>
					...
					<input type="button" value="회원가입" onclick="location.href='Ucontroller.do?command=regist'">
				</td>
			</tr>
		</table>
	</form> 
