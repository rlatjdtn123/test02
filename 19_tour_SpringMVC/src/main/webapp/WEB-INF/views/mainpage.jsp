...
<!--               <h1>1.</h1> -->
              <p class="lead"></p>
              <a class="btn btn-large btn-primary" href="tourlist.do">관광지</a>
            </div>
          </div>
        </div>
        <div class="item">
...
<!--               <h1>2.</h1> -->
              <p class="lead"></p>
              <a class="btn btn-large btn-primary" href="topTen.do">TOP10</a>
            </div>
          </div>
        </div>
        <%if(ldto==null){
...
<!--               <h1>3.</h1> -->
              <p class="lead"></p>
              <a class="btn btn-large btn-primary" href="userInfo.do?id=<%=ldto.getId()%>">마이 페이지</a>
            </div>
          </div>
        </div>
      </div>
...
<!-- <ul style="background-color: orange; width: 100px;"> -->
<!-- 	<li><a href="tourlist.jsp">관광지</a></li> -->
<!-- 	<li><a href="Lcontroller.do?command=topTen">TOP10</a></li> -->
<!-- 	<li>ㅁㄴㅇㄹ</li> -->
<%-- 	<%if(ldto==null){ --%>
		
<!-- // 	}else{ -->
<%-- 		%> --%>
<%-- 			<li><a href="Ucontroller.do?command=userInfo&id=<%=ldto.getId()%>">마이페이지</a></li> --%>
<%-- 		<% --%>
<!-- // 	} -->
<%-- 	%> --%>
<!-- </ul> -->
